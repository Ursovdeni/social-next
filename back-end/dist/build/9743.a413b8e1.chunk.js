...
`,p=(0,e.ZP)(i.x)`
  display: flex;
`,E=a.forwardRef(({children:l,href:c,to:m,disabled:f=!1,startIcon:g,endIcon:v,...j},P)=>{const O=c?"_blank":void 0,M=c?"noreferrer noopener":void 0;return(0,r.jsxs)(x,{as:m&&!f?s.OL:"a",target:O,rel:M,to:f?void 0:m,href:f?"#":c,disabled:f,ref:P,...j,children:[g&&(0,r.jsx)(p,{as:"span","aria-hidden":!0,paddingRight:2,children:g}),(0,r.jsx)(t.Z,{children:l}),v&&!c&&(0,r.jsx)(p,{as:"span","aria-hidden":!0,paddingLeft:2,children:v}),c&&(0,r.jsx)(p,{as:"span","aria-hidden":!0,paddingLeft:2,children:(0,r.jsx)(o.Z,{})})]})})},56233:(h,u,n)=>{"use strict";n.d(u,{m:()=>d});var r=n(85893),a=n(71997),o=n(31988);const s=`${232/16}rem`,e=(0,a.ZP)(o.r)`
  width: ${s};
  ...
  z-index: 1;
`,d=({ariaLabel:t,...i})=>(0,r.jsx)(e,{"aria-label":t,as:"nav",...i})},71603:(h,u,n)=>{"use strict";n.d(u,{p:()=>g});var r=n(85893),a=n(67294),o=n(90272),s=n(71997),e=n(40840),d=n(92058);const t=v=>{const j=(0,a.useRef)();return(0,a.useEffect)(()=>{j.current=v}),j.current};var i=n(26910),x=n(16607),p=n(49185),E=n(35987),l=n(96987),c=n(10574),m=n(96208);const f=(0,s.ZP)(i.i)`
  width: ${24/16}rem;
  background-color: ${({theme:v})=>v.colors.neutral200};
`,g=({as:v="h2",label:j,searchLabel:P="",searchable:O=!1,onChange:M=()=>{},value:C="",onClear:y=()=>{},onSubmit:D=()=>{},id:A})=>{const[_,T]=(0,a.useState)(!1),W=t(_),K=(0,d.M)(A),L=(0,a.useRef)(void 0),R=(0,a.useRef)(void 0);(0,a.useEffect)(()=>{_&&L.current&&L.current.focus(),W&&!_&&R.current&&R.current.focus()},[_,W]);const $=()=>{T(B=>!B)},U=B=>{y(B),L.current.focus()},Z=B=>{B.relatedTarget?.id!==K&&T(!1)},S=B=>{B.key===e.y.ESCAPE&&T(!1)};return _?(0,r.jsxs)(x.x,{paddingLeft:4,paddingTop:5,paddingBottom:2,paddingRight:4,children:[(0,r.jsx)(p.U,{children:(0,r.jsx)(E.w,{name:"searchbar",value:C,onChange:M,placeholder:"e.g: strapi-plugin-abcd",onKeyDown:S,ref:L,onBlur:Z,onClear:U,onSubmit:D,clearLabel:"Clear",size:"S",children:P})}),(0,r.jsx)(x.x,{paddingLeft:2,paddingTop:4,children:(0,r.jsx)(f,{})})]}):(0,r.jsxs)(x.x,{paddingLeft:6,paddingTop:6,paddingBottom:2,paddingRight:4,children:[(0,r.jsxs)(l.k,{justifyContent:"space-between",alignItems:"flex-start",children:[(0,r.jsx)(c.Z,{variant:"beta",as:v,children:j}),O&&(0,r.jsx)(m.h,{ref:R,onClick:$,label:P,icon:(0,r.jsx)(o.Z,{})})]}),(0,r.jsx)(x.x,{paddingTop:4,children:(0,r.jsx)(f,{})})]})}},36636:(h,u,n)=>{"use strict";n.d(u,{E:()=>l});var r=n(85893),a=n(67294),o=n(59233),s=n(71997),e=n(16607),d=n(10574),t=n(96987),i=n(53342);const x=(0,s.ZP)(e.x)`
  display: flex;
  align-items: center;
