"use strict";(self.webpackChunkback_end=self.webpackChunkback_end||[]).push([[4121],{38402:(R,h,t)=>{t.r(h),t.d(h,{default:()=>me});var e=t(67294),s=t(3911),c=t(70743),m=t(36364),g=t(334),L=t(71590),S=t(40720),D=t(90731),k=t(55040),l=t(10574),C=t(12473),P=t(34726),U=t(16607),_=t(5923),ee=t(38454),te=t(3547),K=t(29299),i=t(69398),V=t(12803),ne=t(22304),ae=t(35752),j=t(96987),E=t(85893),F=t(71997);const w=F.ZP.div`
...
`,D=(0,s.ZP)(c.x)`
  ...
  width: 100%;
  border: none;
`,k=({children:l,icon:C,...P})=>(0,e.jsxs)("div",{children:[(0,e.jsx)(m.i,{}),(0,e.jsx)(D,{as:"button",background:"primary100",padding:5,...P,children:(0,e.jsxs)(g.k,{children:[(0,e.jsx)(S,{"aria-hidden":!0,background:"primary200",children:C}),(0,e.jsx)(c.x,{paddingLeft:3,children:(0,e.jsx)(L.Z,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:l})})]})})]})}}]);
